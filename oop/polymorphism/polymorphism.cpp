...
class Employee:Abstract
{
    ...
    public:
        ...
        // Virtual needed only when using polymorphism and obtaining values from attributes.
        virtual void Work()
        {
            cout << Name << " is checking an email, tasks, and performing tasks." << "\n";
        }
...
class SoftwareEngineer:public Employee
{
    public:
        ...
        void Work()
        {
            cout << Name << " is writing code in " << MainLanguage << "\n";
        }
...
class Instructor: public Employee
{
    public:
        ...
        void Work()
        {
            cout << Name << " is lecturing a course in " << Subject << "\n";
        }
...
int main()
{
    ...
    // Pointer
    Employee* dev = &juniorDeveloper;
    Employee* prof = &biomechanics;
    // Does NOT inherit child attributes/polymorphism.
    // Needs "virtual" in front of method to become inheritable.
    dev->Work();
    prof->getsPromoted();
    return 0;
}